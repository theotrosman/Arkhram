    ...
    >
      ...
      <div
        ...
        style={{
          position: "absolute",
          inset: "-20%",
          background: "radial-gradient(ellipse 100% 60% at 50% 80%, rgba(10,2,2,0.9) 0%, transparent 60%)",
          pointerEvents: "none",
        }}
      />
      <div
        ...
        style={{
          position: "absolute",
          inset: "-20%",
          background: "radial-gradient(ellipse 80% 40% at 30% 20%, rgba(20,4,4,0.5) 0%, transparent 60%)",
          pointerEvents: "none",
        }}
      />

      {/* Gothic spires at bottom */}
      <div
        style={{
          position: "absolute",
          bottom: 0,
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", maxWidth: "700px" }}>
        ...
        <motion.div
          ...
          style={{
            height: "1px",
            background: "linear-gradient(90deg, transparent, rgba(139,26,26,0.4), rgba(192,160,96,0.2), rgba(139,26,26,0.4), transparent)",
            marginBottom: "4rem",
        ...
        >
          ...
          >
            &ldquo;The architecture is only visible<br />
            to those who know where to look.&rdquo;
          </h2>
        </motion.div>
        ...
        >
          <div
            style={{
              ...
              color: "transparent",
              WebkitTextStroke: "1px rgba(139,26,26,0.25)",
              marginBottom: "1rem",
            }}
          >
            ARKHRAM
        ...
        >
          ...
          <div style={{ fontFamily: "monospace", fontSize: "0.5rem", letterSpacing: "0.2em", color: "rgba(212,201,184,0.12)", marginTop: "1rem" }}>
            ARKHRAM ORGANIZATION — BUENOS AIRES — 2026
          </div>
        </motion.div>
      </div>
    </section>
